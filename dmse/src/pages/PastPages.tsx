...
export const PastPages = () => {
  return (
    <>
        <h1 className="text-3xl font-mono text-center bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent font-bold">
    ...
    <div className='bg-slate-200/10 rounded-md text-pink-200 block w-[50%] border-[2px] border-blue-100 m-2 p-4'>
    <TableDemo/>
    </div>
