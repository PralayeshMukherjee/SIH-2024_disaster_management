...
export function FloodCard({ onClose }: FloodCardProps) {
  return (
    <Card className="relative w-[400px] bg-white/10  backdrop-filter backdrop-blur-lg shadow-lg rounded-2xl border-hidden text-emerald-200">
      <button
        ...
        <form>
          <div className="grid items-center gap-2 py-2">
            <div className="flex space-x-20 text-center">
              ...
              <p className="font-light">Assam</p>
              </div>
            <div className="flex space-x-20 text-center">
